...
FileProgress.prototype.setComplete = function () {
	...
	edit_name.style.paddingLeft = "35px";
	edit_name.style.background= "#f7f7f7 url(/assets/img/icon-24/"+file_type+".png) no-repeat 10px 50%";
	edit_name.innerHTML = this.fileName;
	var file_path = document.getElementById("file_path");
	file_path.value = this.serverData;
};
