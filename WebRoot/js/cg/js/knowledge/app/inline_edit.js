...
$('span[ectype="inline_edit"]').click(function(){
    ...
    var input_maxlength = $(this).attr('input_maxlength');
    var input_heigth = $(this).attr('input_heigth');
    $('<input type="text">').css({border:'1px solid #ccc',width:'100%',height:input_heigth})
		.attr({value:s_value,size:5,maxlength:input_maxlength})
