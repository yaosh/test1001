...
public class HttpsServerAction
{
    public void download(HttpServletRequest request, HttpServletResponse response)
    {
        File file1 = new File("d:\\2.sql");
        File file2 = new File("d:\\8.21.xls");
        File file3 = new File("d:\\cg_brand.csv");
        File file4 = new File("d:\\cv_brand.csv");
        ...
        try
        {
            downLoadFiles(list,request,response);
        }
        catch (Exception e)
        {
            e.printStackTrace();
