...
*
 */
public class MultiStringHash
{
    private Map<String,Object> myMap = new ConcurrentHashMap<String,Object>();
    
	public static void main(String[] argvs)
	{
		MultiStringHash multiMap = new MultiStringHash();
		
		multiMap.put(multiMap.k("101","20140101","10000000"), "");
		
		
		multiMap.put("","101","20140101","10100000");
		multiMap.put("","101","20140101","10200000");
		multiMap.put("","101","20140102","10000000");
		multiMap.put("","101","20140102","11000000");
		
		multiMap.put("","201","20140102","11000000");
		multiMap.put("","201","20140103","11000000");
		multiMap.put("","201","20140104","11000000");
		multiMap.put("","201","20140104","12000000");
	...
	* @throws
	 */
	public synchronized void put(String []keys,String value)	
	{
		if (isNullArr( keys))
		{
			return;
	...
	* @throws
	 */
	public synchronized void put(String value,String ...keys)	
	{
		if (isNullArr( keys))
		{
			return;
	...
	* @throws
	 */
	@SuppressWarnings("unchecked")
	private void put(String[] keys,String value,Map<String,Object> map)
	{
