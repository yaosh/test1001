...
public class RuleBean
{
    ...
    public RuleBean(String ruleid, String ruleindex, String cgBrand1Name,
    ...
    public String toString()
    {
        ...
        sb.append("编号:").append(ruleid)
        .append("index:").append(ruleindex)
        .append("品牌:").append(cgBrand1Name)
        .append("->").append(cgBrand2Name)
        .append("->").append(cgBrand3Name)
        .append("商家:").append(cgShop1Name)
        .append("->").append(cgShop2Name)
        .append("->").append(cgShop3Name);
