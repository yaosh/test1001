...
public class MultiOptHashMap
{
	...
	public static void main(String[] argvs)
	{
		...
		multiMap.put(multiMap.k("101","20140101","10000000"), 10);
		multiMap.add(multiMap.k("101","20140101","10000000"), 1);
		
		
		multiMap.put(16,"101","20140101","10100000");
		multiMap.put(17,"101","20140101","10200000");
		multiMap.put(18,"101","20140102","10000000");
		multiMap.put(19,"101","20140102","11000000");
		
		multiMap.put(20,"201","20140102","11000000");
		multiMap.put(21,"201","20140103","11000000");
		multiMap.put(22,"201","20140104","11000000");
		multiMap.put(23,"201","20140104","12000000");
	...
	* @throws
	 */
	public synchronized void put(String []keys,int value)	
	{
		if (isNullArr( keys))
		{
			return;
	...
	* @throws
	 */
	public synchronized void put(int value,String ...keys)	
	{
		if (isNullArr( keys))
		{
			return;
	...
	* @throws
	 */
	public synchronized void add(int value,String ...keys)	
	{
		if (isNullArr( keys))
		{
			return;
		...
		int sourceValue = v(keys);
		
		put(keys,sourceValue + value,myMap);
	}
	...
	* @throws
	 */
	public synchronized void add(String []keys,int value)	
	{
		if (isNullArr( keys))
		{
			return;
	...
	* @throws
	 */
	public void minus(int value,String ...keys)	
	{
		if (isNullArr( keys))
		{
			return;
	...
	* @throws
	 */
	public void minus(String []keys,int value)	
	{
		if (isNullArr( keys))
		{
			return;
	...
	* @throws
	...
	public int v(String... keys)
	{
		...
		return (Integer)map.get(keys[keys.length - 1]);
	...
	* @throws
	 */
	@SuppressWarnings("unchecked")
	private void put(String[] keys,int value,Map<String,Object> map)
	{
